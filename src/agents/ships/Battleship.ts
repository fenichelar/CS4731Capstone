...
namespace Game {
  export class Battleship extends Ship {
    ...
    public showDamage(damage: number): void {
      if (damage === 1) {
        this.sprite.addChild(this.sprite.game.make.sprite(0, 0, "battleship_damage_1"));
      } else if (damage === 2) {
        this.sprite.addChild(this.sprite.game.make.sprite(0, 0, "battleship_damage_2"));
      } else if (damage === 3) {
        this.sprite.addChild(this.sprite.game.make.sprite(0, 0, "battleship_damage_3"));
      }
    }
